...
/**
 * display ng2-auto-complete section with input and dropdown list when it is clicked
 */
@Directive({
  selector: "[ng2-auto-complete], [ng2-ng2-auto-complete]"
})
export class Ng2AutoCompleteDirective implements OnInit {

  @Input("ng2-auto-complete-placeholder") autoCompletePlaceholder: string;
  ...
  ngOnInit(): void {
    // wrap this element with <div class="ng2-ng2-auto-complete">
    this.wrapperEl = document.createElement("div");
    this.wrapperEl.className = "ng2-ng2-auto-complete-wrapper";
  ...
  //show ng2-auto-complete list below the current element
  ...
  styleAutoCompleteDropdown = () => {
    if (this.componentRef) {
      ...
      this.acDropdownEl.style.zIndex = "999";

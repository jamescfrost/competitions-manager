...
@Component({
  ...
  <div class="ng2-auto-complete">
    ...
    <ul *ngIf="dropdownVisible && minCharsEntered && (isLoading || filteredList.length)" [class.empty]="emptyList">
  ...
  .ng2-auto-complete > ul li:not(.no-match-found):hover {
    background-color: #ccc;
  }`
  ],
...
export class Ng2AutoCompleteComponent implements OnInit {
  ...
  el: HTMLElement;           // this component  element `<ng2-ng2-auto-complete>`
